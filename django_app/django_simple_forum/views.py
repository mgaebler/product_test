...
def index(request):
    ...
    return render_to_response(
        "django_simple_forum/list.jinja",
        {
            'forums': forums,
            'user': request.user
        },
...
def forum(request, forum_id):
    ...
    return render_to_response("django_simple_forum/forum.html",
...
def topic(request, topic_id):
    ...
    return render_to_response(
        "django_simple_forum/topic.html",
        add_csrf(request, posts=posts, pk=topic_id, topic=topic), context_instance=RequestContext(request)
    )
