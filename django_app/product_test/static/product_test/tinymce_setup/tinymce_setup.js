...
tinyMCE.init({
    ...
    theme_advanced_buttons1: 'formatselect,|,bold,italic,underline,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,justifyfull,|,undo,redo,|,link,unlink,|,image,|,fullscreen,|,code',
